...
from .views import AmbassadorAPIView, ProductGenericAPIView, LinkAPIView, OrderAPIView, RegisterAPIView, LoginAPIView, UserAPIView, LogoutAPIView, ProfileInfoAPIView, ProfilePasswordAPIView
